...
|---|---|
| Lectura de cartolas de múltiples bancos | ✅ Funcionando (probado con datos reales), y ahora invocable como script (`procesar_cartola_cli.py`) |
| Clasificación por palabras clave | ✅ Diseñado, con categorías alineadas al sistema real |
| Registro manual de gastos | ✅ Construido (Java), pendiente de mergear al repositorio |
| Motor de recomendaciones presupuestarias | ✅ Construido y probado, en dos versiones (Java y Python) |
| Historial del perfil financiero en el tiempo | ✅ Construido (tabla + hook), pendiente de mergear al repositorio |
